...
def main():
    ...
    parser.add_argument("--data_dir", type=str, default="raw_datafiles",
                        help="File path to the PSG and annotation files.")
    parser.add_argument("--output_dir", type=str, default="outputs",
                        help="Directory where to save numpy files outputs.")
    parser.add_argument("--subjects_output_dir", type=str, default="outputs_subject",
                        help="Directory where to save numpy files outputs.")
    ...
    select_ch = ['EEG Fpz-Cz', 'EEG Pz-Oz', 'EOG horizontal', 'Resp oro-nasal', 'EMG submental']
